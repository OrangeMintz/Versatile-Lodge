        ...
        <div className="side-bar">
            ...
            {user && user.isAdmin && (
                <nav className="navbar">
                    ...
                    <Link to="/transactions/booked" className={location.pathname.includes('/transactions/booked') || location.pathname.includes('/roomsBooking') ? 'active' : ''}><i className="fa-solid fa-credit-card"></i><span>Transactions</span></Link>
